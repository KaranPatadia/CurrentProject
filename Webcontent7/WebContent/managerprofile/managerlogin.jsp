...
<body>
	...
	<section id="fancyTabWidget" class="tabs t-tabs">
        <ul class="nav nav-tabs fancyTabs" role="tablist">
                    ...
                    <li class="tab fancyTab" id="tabone">
                    ...
                    <li class="tab fancyTab" id="tabtwo">
                    <div class="arrow-down"><div class="arrow-down-inner"></div></div>
                        ...
                        <li class="tab fancyTab" id="tabthree">
                    <div class="arrow-down"><div class="arrow-down-inner"></div></div>
                        	...
                        	<div class="row">
                                ...
                                <div class="col-md-12">
									...
									<script>
										...
										var y=document.getElementbyId("tabBody0");
										System.out.println(y.className());
										if("active".equals(x.className)){
