	...
	<div class="getin">
		...
		<div class="col1">
				...
				<form method="post" action="" class="loginForm">
					...
					<div id="section2">
						<div class="typeUser">
					        <input type='radio' value='1' name='radios' id='radio1' checked/>
					        <label for='radio1'>Customer</label>
					        <input type='radio' value='2' name='radios'  id='radio2'/>
					        <label for='radio2'>Officer</label>
					        <input type='radio' value='3' name='radios'  id='radio3'/>
...
<%
	if("Login".equals(request.getParameter("login"))){
		...
		if(conTrue){
			...
			ch=request.getParameter("radios");
			try{
				if(ch.equals("1")){
			...
			if(rs==null){
				...
				if(flag1==true && flag2==true){
					...
					if(ch.equals("2"))
						response.sendRedirect("../officerprofile/officerlogin.jsp");
					if(ch.equals("3"))
						response.sendRedirect("../managerprofile/managerlogin.jsp");
				}
				else{
					%>
					<script>
